...
def main(env_path, char1_path, char2_path, save_path,  char_x1, char_y1, char_x2, char_y2, cam_x, cam_y, cam_z):
    ...
    for idx in range(2):
        ...
        radius = max(min_radius, max*random.random())
        radius1 = max(min_radius, max*random.random())
...
if __name__ == "__main__":
    ...
    for orig_idx, (env_path, char1_path, char2_path, save_path,  char_x1, char_y1, char_x2, char_y2, cam_x, cam_y, cam_z) in enumerate([
       [ r"C:\Users\user\Downloads\KP_FLAM\KP_FLAM\env1\mall(200X200).glb", r"C:\Users\user\Downloads\KP_FLAM\KP_FLAM\char1\char2.glb", r"C:\Users\user\Downloads\KP_FLAM\KP_FLAM\char1\char5.glb", r"C:\Users\user\Downloads\KP_FLAM\KP_FLAM\test",120,100,80,100,100,30,25],
