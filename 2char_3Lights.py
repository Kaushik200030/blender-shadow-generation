...
bpy.ops.import_scene.gltf(filepath='/Users/kaushikpattanayak/Desktop/KP_Flam/Blender Script/Environments/warehouse2.glb')
...
character1.location = ( int(char_x-char_x/10), char_y, 0) # Place the character at the center of the scene


bpy.ops.import_scene.gltf(filepath='/Users/kaushikpattanayak/Desktop/KP_Flam/Blender Script/Environments/kara_-_detroit_become_human.glb')
character2 = bpy.context.selected_objects[0]  # Assuming the character is the first object imported
character2.location = ( int(char_x+char_x/10), char_y, 0) # Place the character at the center of the scene
